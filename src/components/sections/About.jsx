        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            <p className="text-gray-300 mb-6">
              ...
              seamlessly. <br />
              <br />
              My approach is always user-centered: I focus on delivering apps
              and websites that are simple to use, fast, and effective, without
              compromising on functionality or performance. I believe that great
              software should feel natural, providing users with an effortless
              and enjoyable experience. Whether you're looking for a powerful
              mobile app or a robust web platform, my goal is to craft solutions
              that fit your needs while keeping the experience smooth and
              intuitive. <br />
              <br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                ...
                <li>Independently by courses</li>
              </ul>
            </div>
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  <h4 className="font-semibold">
                    {" "}
                    Worked as a freelancer (2024-2025)
                  </h4>
                  <p>
                    Completed tasks for various clients to create Kotlin
                    applications and create mods and plugins for Minecraft
                  </p>
                </div>
                ...
                <div>
                  <h4 className="font-semibold">
                    {" "}
                    Worked for a ceramics company (Still working)
                  </h4>
                  <p>Created utility applications for the company</p>
                </div>
              </div>
            </div>
          </div>
